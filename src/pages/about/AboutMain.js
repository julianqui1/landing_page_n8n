            ...
            <div className="row align-items-center">
              <div className="col-xl-6 col-lg-6 col-md-7">
                <div className="funfact-2__content">
                  <div
                    className="funfact-2__text wow animate__fadeInUp"
                    data-wow-duration=".9s"
                    data-wow-delay=".3s"
                  >
                    <h4
                  ...
                  <div
                    className="funfact-2__button wow animate__fadeInUp"
                    data-wow-duration=".9s"
                    data-wow-delay=".7s"
                  >
                    <a className="border-btn-3 bg-color-1 mb-20 mr-15" href="#">
                      <i className="fab fa-apple"></i> App Store
                    </a>
                    <a className="border-btn-3 bg-color-2 mb-20" href="#">
              ...
              <div className="col-xl-6 col-lg-6 col-md-5">
                <div
                  className="funfact-2__main-img d-none d-md-block wow animate__fadeInUp"
                  data-wow-duration=".9s"
                  data-wow-delay=".9s"
                >
