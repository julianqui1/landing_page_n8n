...
const TestimonialMain = () => {
  return (
    <main>
      <Breadcrumb pageTitle="Testimonial" />
      ...
      <div className="testimonial__area testimonial__plr p-relative">
        <div className="container-fluid">
          ...
          <div className="row">
            <div
              className="col-xl-6 col-lg-12 col-md-12 col-sm-6 pb-30 wow animate__fadeInUp"
              data-wow-duration=".9s"
              data-wow-delay=".3s"
            >
              <SingleTestimonial authorImg={testimonialImg1} />
            </div>
            <div
              className="col-xl-6 col-lg-12 col-md-12 col-sm-6 pb-30 wow animate__fadeInUp"
              data-wow-duration=".9s"
              data-wow-delay=".4s"
            >
              <SingleTestimonial authorImg={testimonialImg2} />
            </div>
            <div
              className="col-xl-6 col-lg-12 col-md-12 col-sm-6 pb-30 wow animate__fadeInUp"
              data-wow-duration=".9s"
              data-wow-delay=".5s"
            >
              <SingleTestimonial authorImg={testimonialImg3} />
            </div>
            <div
              className="col-xl-6 col-lg-12 col-md-12 col-sm-6 pb-30 wow animate__fadeInUp"
              data-wow-duration=".9s"
              data-wow-delay=".7s"
            >
              <SingleTestimonial authorImg={testimonialImg4} />
            </div>
            <div
              className="col-xl-6 col-lg-12 col-md-12 col-sm-6 pb-30 wow animate__fadeInUp"
              data-wow-duration=".9s"
              data-wow-delay=".8s"
            >
              <SingleTestimonial authorImg={testimonialImg5} />
            </div>
            <div
              className="col-xl-6 col-lg-12 col-md-12 col-sm-6 pb-30 wow animate__fadeInUp"
              data-wow-duration=".9s"
              data-wow-delay=".9s"
            >
              <SingleTestimonial authorImg={testimonialImg6} />
            </div>
          </div>
        </div>
      </div>
