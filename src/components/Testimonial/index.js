...
const SingleTestimonial = (props) => {
  const { itemClass, shapeImg, authorImg, Name, Designation, Description } =
    props;
  return (
    <div
      className={
        itemClass
          ? itemClass
          : 'testimonial__item d-flex justify-content-betweena align-items-center p-relative'
      }
    >
      ...
      <div className="testimonial__content">
        <div className="testimonial__author-info">
          <h5 className="testimonial__author-name">
            {Name ? Name : 'Karon Rubel'}
          </h5>
        ...
        <div className="testimonial__content-text">
          <p>
            {Description
              ? Description
              : 'We are privileged to work with hundreds future businesses, including many of the world’s software, and brands.'}
          </p>
